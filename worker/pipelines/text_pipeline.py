...
{{
  ...
  "education": [
    {{
      ...
      "level": "степень (бакалавр/магистр/специалист)",
  ...
  "experience": [
    {{
      "company": "компания",
      "position": "должность",
      "start_date": "месяц год начала",
      "end_date": "месяц год окончания или 'настоящее время'",
      "responsibilities": "обязанности и достижения"
    }}
  ],
  "skills": {{
    "hard_skills": {{
      "technical": ["технология1", "технология2"],
      "professional": ["архитектура", "паттерны"],
      "languages": ["язык - уровень"]
    }},
...
- Если данных нет - оставляй пустые строки
- Верни ТОЛЬКО JSON"""
...
Формат:
{{"personal_data": {{"last_name": "", "first_name": "", "email": "", "phone": "", "city": ""}}, "education": [], "experience": [], "skills": {{"hard_skills": {{"technical": [], "professional": [], "languages": []}}, "soft_skills": []}}, "additional": {{"certificates": [], "projects": [], "achievements": {{"awards": [], "publications": [], "conferences": []}}}}}}
